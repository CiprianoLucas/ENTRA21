...
def index(request):
    ...
    stocks = ProductInventory.objects.all()
...
def create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            stock_form = ProductInventoryFormSet(request.POST, instance=product)
            ...
            if supplier_product_formset.is_valid():
                ...
                if stock_form.is_valid():
                    ...
                    messages.error(request, "Falha ao cadastrar a quantidade")

                    stock_form = ProductInventoryFormSet(request.POST)
            
                    context = { "form": form, "supplier_product_formset": supplier_product_formset, "form_action": form_action, "form_stock": stock_form }
    ...
    # GET
    form = ProductForm()
    stock_form = ProductInventoryFormSet()
